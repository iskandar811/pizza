...
// Set the cookie with secure and HTTP-only attributes
$cookieName = "opd_cookie";
$cookieValue = "pizza";
$expiry = time() + (86400 * 30); // Expiration time (e.g., 30 days from now)

// Set the cookie with secure and HTTP-only attributes
setcookie($cookieName, $cookieValue, $expiry, '/', 'example.com', true, true);
