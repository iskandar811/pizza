        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="Jalan Harmoni 1/16" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Address Line 2:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="Taman Melawati" type="text">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="1xxxxxxxxx" required pattern="{10}" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group col-md-6 mb-0">
